...
config.set_section_option(section, "POSTGRES_USER", os.getenv("POSTGRES_USER", "botuser"))
config.set_section_option(section, "POSTGRES_PASSWORD", os.getenv("POSTGRES_PASSWORD", "changeme"))
...
config.set_section_option(section, "POSTGRES_DB", os.getenv("POSTGRES_DB", "telegram_bot"))
